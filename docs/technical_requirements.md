...
Также предусмотреть возможность покупки подарочного кода. Градация подарочных
кодов: код на определенную сумму, код на пост, код на подписку. У подписчика
должна быть возможность при оплатах использовать подарочный код.
