...
2. [Описание системы](#2-описание-системы)
    1. [Типы пользователей](#21-типы-пользователей)
    2. [Регистрация](#22-регистрация)
    3. [Аутентификация автора и подписчиков](#23-аутентификация-автора-и-подписчиков)
    4. [Функционал для автора](#24-функционал-для-автора)
        1. [Редактирование профиля](#241-редактирование-профиля)
        2. [Заведение и редактирование типов подписки](#242-заведение-и-редактирование-типов-подписки)
        3. [Заведение и редактирование контента](#243-заведение-и-редактирование-контента)
        4. [Заведение и редактирование целей](#244-заведение-и-редактирование-целей)
        5. [Рассылки](#245-рассылки)
    5. [Функционал оплаты подписки или разового платежа и главной страницы](#25-функционал-оплаты-подписки-или-разового-платежа-и-главной-страницы)
        1. [Рекуррентные платежи](#251-рекуррентные-платежи)
    6. [Функционал для подписчика](#26-функционал-для-подписчика)
    7. [Функционал интеграции с Telegram](#27-функционал-интеграции-с-telegram)
    8. [Уведомления о новых постах](#28-уведомления-о-новых-постах)
3. [Предлагаемый стек технологий](#3-предлагаемый-стек-технологий)
4. [Требования к дизайну](#4-требования-к-дизайну)
